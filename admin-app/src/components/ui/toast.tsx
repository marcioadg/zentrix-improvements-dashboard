        ...
        toastReference.current = sonnerToast.custom(
          (toastId) => (
            <motion.div
              ...
              className={cn(
                'flex items-center justify-between w-full max-w-xs p-3 rounded-[6px] border shadow-sm',
            ...
            >
              ...
              <div className="flex items-center gap-2">
                {actions?.label && (
                  <Button
                    ...
                    className={cn(
                      'cursor-pointer',
                      variant === 'success'
                        ? 'text-success border-green-600 hover:bg-green-600/10 dark:hover:bg-green-400/20'
                        : variant === 'error'
                ...
                <button
                  ...
                  className="rounded-full p-1 hover:bg-muted/50 dark:hover:bg-muted/30 transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-primary"
...
export { type ToasterProps, type Variant, type Position, type ActionButton };