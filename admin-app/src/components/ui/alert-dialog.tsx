...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // Keep AlertDialog ABOVE any Dialog overlays/content (Dialog uses z-[100]/z-[101]).
      // Otherwise the overlay blocks interaction while the confirm content renders behind it.
      "fixed inset-0 z-[200] bg-foreground/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
