...
import { Activity, Users, Clock, TrendingUp, Calendar, ArrowUpDown, Search } from 'lucide-react';
...
export const PlatformUsageContent: React.FC = () => {
  ...
  if (loading) {
    return <LoadingState message="Loading platform usage data..." />;
  }
